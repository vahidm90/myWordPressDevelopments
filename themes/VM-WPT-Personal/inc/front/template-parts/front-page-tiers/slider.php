...
if ( have_posts() ) :
	...
	while ( have_posts() ) :
		...
		the_post();
		$post_img   = vm_get_post_img_url( $id, 'medium', true );
		$post_cat   = get_the_category()[0]->name;
		$post_title = get_the_title();
		$post_time  = vm_get_post_relative_time( $id );
...
<nav class="d-flex align-items-center justify-content-center position-absolute" id="scroll-down">
    <a href="#tier-2" class="dashicons-arrow-down-alt2 dashicons-before text-decoration-none"></a>
</nav>
